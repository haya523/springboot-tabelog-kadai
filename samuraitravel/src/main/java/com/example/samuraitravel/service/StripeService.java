...
public class StripeService {
    ...
    // application.properties などから注入（空でもOK）
    ...
    public String createStripeSession(String houseName,
        ...
        // 念のためランタイムでもチェック（null/空なら例外）
        if (Stripe.apiKey == null || Stripe.apiKey.isBlank()) {
            throw new IllegalStateException("Stripe APIキーが設定されていません。（stripe.api-key）");
        }
    ...
    // セッションから予約情報を取得し、ReservationService経由でDB登録
